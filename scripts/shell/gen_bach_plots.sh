...
Rscript master_visualization.R -q "bach_icml.txt" -d $RESULTS_PATH -s $SMOOTH -b $BURNIN -p "." -v train_log_likelihood,test_log_likelihood --remove=acf -r $PROJECT_ROOT
