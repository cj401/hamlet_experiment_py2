...
Rscript master_visualization.R -q "synth16_noBFact.txt" -d $RESULTS_PATH -s $SMOOTH -b $BURNIN -p "." -v alpha,gamma,train_log_likelihood,test_log_likelihood,n_dot,A -r $PROJECT_ROOT
