...
\begin{figure}[tb]
  \centering
  \includegraphics[width = 0.3\textwidth]{fig/cocktail/hsmm/noise_a1b1/cp_0/accuracy}
  \includegraphics[width = 0.3\textwidth]{fig/cocktail/hsmm/noise_a1b1/cp_0/F1_score}
  \includegraphics[width = 0.3\textwidth]{fig/cocktail/hsmm/noise_a1b1/cp_0/train_log_likelihood}
  \includegraphics[width = 0.3\textwidth]{fig/cocktail/hsmm/noise_a1b1/cp_0/test_log_likelihood}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width = 0.3\textwidth]{fig/cocktail/hsmm/noise_a1b1/cp_0/n_dot}
  \includegraphics[width = 0.3\textwidth]{fig/cocktail/hsmm/noise_a1b1/cp_0/lambda}
...
% \begin{figure}[tb]
%   \centering
%   \includegraphics[width = 0.3\textwidth]{fig/cocktail/hsmm/noise_a1b1/cp_0/thetastar}
%   \includegraphics[width = 0.3\textwidth]{fig/cocktail/hsmm/noise_a1b1/cp_0/lambda}
%   \caption{Number of states used on the training data (top), and
%     learned decay rate for the LT model (bottom) on the cocktail data. The first 100
%     iterations are excluded.}
